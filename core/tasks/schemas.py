...
class TaskBaseSchema(BaseModel):
    ...
    description: Optional[str] = Field(None, max_length=150, description="Descripton of the task")
...
class TaskResponseSchema(TaskBaseSchema):
    ...
    updated_date : datetime = Field(..., description="Creation date and time of the object")